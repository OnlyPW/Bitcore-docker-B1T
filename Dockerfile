...
# Build-Quelle wählen:
#   SOURCE_BUILD=0 (Default): gepatchte Release-Binaries v4.0.1.0 aus OnlyPW/Bit-core laden
...
ARG SOURCE_BUILD=0
ARG BIT_URL=https://github.com/OnlyPW/Bit-core/releases/download/v4.0.1.0/Bit-v4.0.1.0.tar.gz
